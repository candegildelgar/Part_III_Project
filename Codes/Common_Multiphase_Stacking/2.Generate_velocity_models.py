...
#Note that for the synthetic tests, the Vp_vals had to be manually input in arrays, whereas for the real data these are read from a .csv file

#Also not shown, but RFs were generated using CPS hrftn96 module, which run from terminal
