...
"""
    ...
    for count, rf_file in enumerate(RF_files, start=1):
        ...
        if sta_id=='APAL' or sta_id=='OLGR' or sta_id== 'MYNG' or sta_id=='HELL' or sta_id== 'OSVA' or sta_id=='VITI' or sta_id == 'OSKV' or sta_id=='ATOP' or sta_id=='JONG' or sta_id=='JONS' or sta_id=='GODA' or sta_id=='VBOR' or sta_id=='KLUR':
            with open('/raid2/cg812/Synthetic_RF_with_two_chambers/Gauss_2_0.1_melt_icelandic_crust.pkl', 'rb') as pick_file:
...
def plot_cross_section(output_path, grid_dist, grid_depth, weight_norm_vol, maskdist, maskdep, 
    ...
    plt.tight_layout()
    plt.savefig(f"{output_path}/ccp_Multiphase_cross-section_{startlat}_{startlon}_{endlat}_{endlon}_fres_{stacking_smooth_fresnel}_Gauss{gauss_direct}_{gauss_mult}_3D_model_C_NE.png", dpi=300, bbox_inches="tight")
    plt.close()
...
def save_outputs(
    ...
    outfile = f"{output_path}/CROSS-SECTION_Multiphase_{startlat}_{startlon}_{endlat}_{endlon}_fres_{stacking_smooth_fresnel}_Gauss{gauss_direct}_{gauss_mult}_slice_3D_model_C_NE.txt"
    ...
    outfile_pos = f"{output_path}/CROSS-SECTION_Multiphase_{startlat}_{startlon}_{endlat}_{endlon}_fres_{stacking_smooth_fresnel}_Gauss{gauss_direct}_{gauss_mult}_peakspos_3D_model_C_NE.txt"
    ...
    outfile_neg = f"{output_path}/CROSS-SECTION_Multiphase_{startlat}_{startlon}_{endlat}_{endlon}_fres_{stacking_smooth_fresnel}_Gauss{gauss_direct}_{gauss_mult}_peaksneg_3D_model_C_NE.txt"
    ...
    outfile_mask = f"{output_path}/CROSS-SECTION_Multiphase_{startlat}_{startlon}_{endlat}_{endlon}_fres_{stacking_smooth_fresnel}_Gauss{gauss_direct}_{gauss_mult}_3D_model_C_NE.txt"
    ...
    output_file = f"{output_path}/CROSS-SECTION_Multiphase_{startlat}_{startlon}_{endlat}_{endlon}_fres_{stacking_smooth_fresnel}_Gauss{gauss_direct}_{gauss_mult}_3D_model_C_N_E.pkl"
...
RF_files_direct = ['/raid2/cg812/Synthetic_RF_with_two_chambers/Gauss_6_icelandic_crust.pkl']*len(glob.glob('/raid2/cg812/All_together/Gauss_6.0/*[!.png]'))
RF_files_mult = ['/raid2/cg812/Synthetic_RF_with_two_chambers/Gauss_2_icelandic_crust.pkl']*len(glob.glob('/raid2/cg812/All_together/Gauss_2.0/*[!.png]'))
